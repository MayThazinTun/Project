    ...
    <div>
        ...
        <div>
            <ul class="nav me-4" style="justify-content: center;">
                ...
                <li class="nav-item">
                    <a href="./tshirt.php" class="nav-link text-secondary">T-shirts</a>
                </li>
                <li class="nav-item">
                    <a href="./store.php" class="nav-link text-secondary">Store</a>
                </li>
                <li class="nav-item">
                    <a href="./carts.php" class="nav-link text-secondary">Cart</a>
                </li>
                <li class="nav-item">
                    <a href="./history.php" class="nav-link text-secondary">History</a>
                </li>
                <li class="nav-item">
                    <a href="./account.php" class="nav-link text-secondary">My account</a>
                </li>
            </ul>
        </div>
    </div>
