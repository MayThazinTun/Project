<nav class="d-flex justify-content-between py-2 px-5 border border-bottom-2">
    ...
    <div class=" m-0 py-2">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="./tshirt.php" class="nav-link text-dark" title="T-shirts"><i class="fa-solid fa-shirt fa-xl" style="color: #000000;"></i></a>
            </li>
            <li class="nav-item">
                <a href="./store.php" class="nav-link text-dark" title="Store"><i class="fa-solid fa-store fa-xl" style="color: #000000;"></i></a>
            </li>
            <li class="nav-item" aria-label="">
                <!-- check already login or not -->

                <a href="./carts.php" class="nav-link text-dark" title="Cart"><i class="fa-solid fa-cart-shopping fa-xl"
                        style="color: #000000;"></i></a>
            </li>

            <!-- history after login or register-->
            <li class="nav-item">
                <a href="./history.php" class="nav-link text-dark" title="History"><i class="fa-solid fa-clock-rotate-left fa-xl" style="color: #000000;"></i></a>
            </li>
            ...
            <li class="nav-item">
                <a href="./account.php" class="nav-link text-dark" title="My Account"><i class="fa-solid fa-circle-user fa-xl" style="color: #000000;"></i></a>
            </li>
        </ul>
    </div>
</nav>