...
$default_avatar_folder = "../../images/stickers/";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($sticker_price)) $price_error = "Price must not be empty";
    ...
    if (empty($price_error)) {
        if (!empty($photos_paths)) {
            ...
            $photo_paths_str = "../../images/stickers/sticker1.png";
        }
        if (create_sticker($mysqli, $sticker_price, $photo_paths_str)) {
...
<div class="container mt-2">
    <h1 class="text-center my-4">Create New Sticker</h1>
    <div class="d-flex justify-content-center">
        <div class="card col-7 p-5">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group row mb-3">
                    <div class="col-4">
                        <label for="sticker_price" class="form-label">Price</label>
                    </div>
                    <div class="col-8">
                        <input type="number" name="sticker_price" class="form-control" value="<?php echo htmlspecialchars($sticker_price); ?>" id="sticker_price">
                ...
                <div class="form-group row mb-3">
                    <div class="col-4">
                        <label class="form-label">Default Sticker</label>
                    </div>
