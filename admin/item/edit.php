...
$item_id = isset($_GET['updated_id']) ? (int)$_GET['updated_id'] : null;
$item = null;
...
if (isset($_POST['submit'])) {
    ...
    //     }
    //     if (empty($item_note)) {
    //         $item_note_error = "Item note is required";
    //     }

    //     if (empty($item_price_error) && empty($item_quantity_error)) {
    //         $photo_paths_str = implode(",", $photos_paths);
    //         $result = update_item($mysqli, $item_id, $category_id, $type_id, $color_id, $size_id, $sticker_id, $item_price, $item_quantity, $item_note);
    //         if ($result) {
    ...
    // } else {
        ...
        if (empty($item_name_error) && empty($item_price_error) && empty($item_quantity_error)) {
            $photo_paths_str = implode(",", $photos_paths);
            $result = update_item_all($mysqli, $item_id, $category_id, $type_id, $color_id, $size_id, $sticker_id, $item_price, $item_quantity, $item_description);
            if ($result) {
                header("Location: index.php");
                exit;
            } else {
