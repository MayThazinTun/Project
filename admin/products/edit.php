...
if (isset($_POST['submit'])) {
    ...
    if (empty($type_id) && empty($color_id) && empty($size_id) && empty($sticker_id)) {
        ...
        if (empty($product_name_error) && empty($product_price_error) && empty($product_quantity_error)) {
            ...
            $result = update_product($mysqli, $product_id, $category_id, $type_id, $color_id, $size_id, $sticker_id, $product_name, $product_price, $product_quantity, $photo_paths_str, $product_description);
            if ($result) {
